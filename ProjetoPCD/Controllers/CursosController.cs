...
namespace ProjetoPCD.Controllers
{
    public class CursosController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("id_Curso,Nome,Descricao,Imagem")] Curso curso)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("id_Curso,Nome,Descricao,Imagem")] Curso curso)
        {
